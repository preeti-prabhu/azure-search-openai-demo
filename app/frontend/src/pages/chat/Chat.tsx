                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Nautisense MantaMind@Azure</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask me anything about Purifiers</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What are the specific steps involved in an overhaul service for the purifier?)"
                            disabled={isLoading}
